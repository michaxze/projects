...
#  match "/signout" => "sessions#destroy", :as => :signout
  ...
  match "/terms" => "pages#terms", :as => :terms
	match "/notfound" => "pages#notfound", :as => :notfound
  ...
  match "/verify" => "login#verify", :as => :verify
  match "/errors" => "pages#errors", :as => :errors
  match "/help" => "pages#help", :as => :help
  match "/help_biz" => "pages#help_biz", :as => :help_biz
  ...
  match "/update_listing_notification" => "account#update_listing_notification", :as => :update_listing_notification
  ...
  resource :registration, :controller => :registration do
    collection do
      ...
      get :update_pricing_information
      get :validate_email
      get :validate_cname
    end
  end

  resources :maps, :controller => :maps do
    collection do
      get :get_information
      get 'load_more'
    end
  ...
  resource :business, :controller => "business" do
    collection do
      get "search_state_autocomplete"
      get "search_country_autocomplete"
      get "search_state"
      get "search_section"
      get "search_city"
      get "search_postcode"
